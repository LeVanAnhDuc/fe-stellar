...
function Pay() {
    ...
    console.log("ngoài pay: ", idBooking)
    ...
    const handlePay = () => {
        ...
        console.log("trong pay: ", idBooking)
        bookingRoomApi.payment(idBooking, bank).then((res) => {
            ...
            <strong>Thẻ ATM / Tài khoản ngân hàng</strong>
            {
                logobank.map((item, index) =>(
                    <Col md="2" key={item.id} className={cx('item')}>
                            ...
                            onClick={() => handleClick(index)}  value ={item.value} />
                    </Col>
            ) )}
            ...
            <Col>
                ...
                <div className={cx('text')}>
                    ...
                    <div className={cx('btn')}>
                        ...
                        <Button onClick={handlePay} rightIcon={true} leftIcon filled_2 >Thanh Toán</Button>
                    </div>
                </div>
                </div>
            </Col>
