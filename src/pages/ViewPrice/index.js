            ...
            <Row className={cx('Room')}>
                ...
                <Col className={cx('col')}>
                    <Row className={cx('InfoRoom')}>
                        ...
                        <p>Phòng Suite Garden được phối hợp phong cách hiện đại với cảm hứng từ cây xanh, rộng rãi, hoàn hảo cho các kì nghỉ cuối tuần hay chuyến khám  phá của quý khách. Ban công rộng và được sắp xếp để quý khách luôn cảm  nhận được không khí trong lành, gió nhẹ lay và bóng mát từ các tán cây
                        </p>
                        <div style={{display:' flex'}}>
                        <p><b>Diện tích: </b> 40 m2 </p> 
                        <p><b>Loại giường:</b> 1 giường queen</p> 
                        </div>
                        <a href='/dat-phong'><i>Xem các tiện ích</i></a>
                        <hr  width="30%" align="center"  />
                    </Row>
                    <Row style={{alignItems: "center"}}>
                        <Col>
                            <p><i style={{color:"red", fontSize:"1.3rem"}} >Còn 2 phòng trống</i></p>
                        </Col>
                        <Col>
